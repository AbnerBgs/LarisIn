...
export interface OriginButtonProps extends Omit<
    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          "shadow-[0_0_0_1px_rgba(17,17,17,0.08)]",
          className,
        )}
      ...
      >
        <motion.span
          ...
          aria-hidden
          className="pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#f2f2f2] dark:bg-[#f5f5f5]"
          initial={false}
          style={{
            height: coverSize,
            left: origin.x,
